...
> 本文转自：[https://overreacted.io/zh-hans/how-does-react-tell-a-class-from-a-function/](https://overreacted.io/zh-hans/how-does-react-tell-a-class-from-a-function/)
...
就像我[上一篇博客](https://overreacted.io/why-do-we-write-super-props/)中提到的，**你并不需要知道这个才能高效使用 React。** 我多年来都不知道这个。请不要把这变成一道面试题。事实上，这篇博客更多的是关于 JavaScript 而不是 React。
...
// greeting
//   .__proto__ → Greeting.prototype (   我们从这儿开始)
//     .__proto__ → React.Component.prototype (✅ 找到了！)
//       .__proto__ → Object.prototype
```
